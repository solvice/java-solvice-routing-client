# onroute-api OpenAPI Specification
[![Build Status](https://travis-ci.com/solvice/onroute-api-docs.svg?branch=master)](https://travis-ci.com/solvice/onroute-api-docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://solvice.github.io/onroute-api-docs/)
- [SwaggerUI](https://solvice.github.io/onroute-api-docs/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://solvice.github.io/onroute-api-docs/openapi.json) [YAML](https://solvice.github.io/onroute-api-docs/openapi.yaml)
