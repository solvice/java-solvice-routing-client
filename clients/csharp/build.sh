...
${nuget_cmd} install src/SolviceRoutingClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/SolviceRoutingClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/SolviceRoutingClient.dll \
-recurse:'src/SolviceRoutingClient/*.cs' \
-doc:bin/SolviceRoutingClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/SolviceRoutingClient.dll was created successfully"
fi
