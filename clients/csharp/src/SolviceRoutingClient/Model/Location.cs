...
namespace SolviceRoutingClient.Model
{
        ...
        public partial class Location :  IEquatable<Location>, IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        /// <param name=""> (required).</param>
        public Location(string  = default(string), double?  = default(double?), double?  = default(double?))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for Location and cannot be null");
            }
            else
            {
                this.Name = ;
