...
public class VrpApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSolutionVrpCall(UUID jobId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/jobs/{jobId}/solution#VRP"
            .replaceAll("\\{" + "jobId" + "\\}", apiClient.escapeString(jobId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSolutionVrpValidateBeforeCall(UUID jobId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling getSolutionVrp(Async)");
        }
        
        com.squareup.okhttp.Call call = getSolutionVrpCall(jobId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RoutingSolution getSolutionVrp(UUID jobId) throws ApiException {
        ApiResponse<RoutingSolution> resp = getSolutionVrpWithHttpInfo(jobId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RoutingSolution> getSolutionVrpWithHttpInfo(UUID jobId) throws ApiException {
        com.squareup.okhttp.Call call = getSolutionVrpValidateBeforeCall(jobId, null, null);
        Type localVarReturnType = new TypeToken<RoutingSolution>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Solution VRP (asynchronously)
     * Returns the actual solution of the VRP. Only present when the status is &#x60;SOLVED&#x60;.
     * @param jobId The job ID. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSolutionVrpAsync(UUID jobId, final ApiCallback<RoutingSolution> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSolutionVrpValidateBeforeCall(jobId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RoutingSolution>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param body VRP problem solve request (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call solveVRPCall(VRP body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/solve#VRP";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call solveVRPValidateBeforeCall(VRP body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Job solveVRP(VRP body) throws ApiException {
        ApiResponse<Job> resp = solveVRPWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Job> solveVRPWithHttpInfo(VRP body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call solveVRPAsync(VRP body, final ApiCallback<Job> callback) throws ApiException {
