...
namespace Swagger\Client\routing-client;
...
class TMPApi
{
     ...
     * gets a job
     *
     * @param  string $job_id The job ID. (required)
     *
    ...
    {
        $returnType = '\Swagger\Client\Model\Job';
        $request = $this->getJobStatusRequest($job_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getJobStatusAsync($job_id)
    {
        return $this->getJobStatusAsyncWithHttpInfo($job_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getJobStatusAsyncWithHttpInfo($job_id)
    {
        $returnType = '\Swagger\Client\Model\Job';
        $request = $this->getJobStatusRequest($job_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getJobStatusRequest($job_id)
    {
        // verify the required parameter 'job_id' is set
        if ($job_id === null || (is_array($job_id) && count($job_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * solve a TMP problem
     *
     * @param  \Swagger\Client\Model\TMP $body TMP problem solve request (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function solveTMP($body = null)
    {
        $this->solveTMPWithHttpInfo($body);
    }

    /**
     * Operation solveTMPWithHttpInfo
     *
     * solve a TMP problem
     *
     * @param  \Swagger\Client\Model\TMP $body TMP problem solve request (optional)
     ...
     */
    public function solveTMPWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->solveTMPRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solveTMPAsync($body = null)
    {
        return $this->solveTMPAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solveTMPAsyncWithHttpInfo
     *
     * solve a TMP problem
     *
     * @param  \Swagger\Client\Model\TMP $body TMP problem solve request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solveTMPAsyncWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->solveTMPRequest($body);
    ...
    /**
     * Create request for operation 'solveTMP'
     *
     * @param  \Swagger\Client\Model\TMP $body TMP problem solve request (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function solveTMPRequest($body = null)
    {

        $resourcePath = '/solve#TMP';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
