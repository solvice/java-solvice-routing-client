...
class VRPApi
{
     ...
     * solve a VRP problem
     *
     * @param  \Swagger\Client\Model\VRP $body VRP problem solve request (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Job
     */
    public function solveVRP($body = null)
    {
        list($response) = $this->solveVRPWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation solveVRPWithHttpInfo
     *
     * solve a VRP problem
     *
     * @param  \Swagger\Client\Model\VRP $body VRP problem solve request (optional)
     ...
     * @return array of \Swagger\Client\Model\Job, HTTP status code, HTTP response headers (array of strings)
     */
    public function solveVRPWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\Job';
        $request = $this->solveVRPRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solveVRPAsync($body = null)
    {
        return $this->solveVRPAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solveVRPAsyncWithHttpInfo
     *
     * solve a VRP problem
     *
     * @param  \Swagger\Client\Model\VRP $body VRP problem solve request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solveVRPAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\Job';
        $request = $this->solveVRPRequest($body);
    ...
    /**
     * Create request for operation 'solveVRP'
     *
     * @param  \Swagger\Client\Model\VRP $body VRP problem solve request (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function solveVRPRequest($body = null)
    {

        $resourcePath = '/solve#VRP';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
