...
class SolviceAPIApi(object):
    ...
    def get_job(self, job_id, **kwargs):  # noqa: E501
        ...
        When posting a new solve request, this job can be checked again under this endpoint. In fact, it should be the entire request posted as-is.  # noqa: E501
    ...
    def get_solution(self, job_id, **kwargs):  # noqa: E501
        ...
        Returns the actual solution of the job. Only present when the status is `SOLVED`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_stats(self, job_id, **kwargs):  # noqa: E501
        """Statistics  # noqa: E501

        Returns the information on why a job has been solved the way it's been. Information includes specific unresolved objects. Want to know how it is optimised? This endpoint lets you know what rules have been overruled.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_stats(job_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_stats_with_http_info(job_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_stats_with_http_info(job_id, **kwargs)  # noqa: E501
            return data

    def get_stats_with_http_info(self, job_id, **kwargs):  # noqa: E501
        """Statistics  # noqa: E501

        Returns the information on why a job has been solved the way it's been. Information includes specific unresolved objects. Want to know how it is optimised? This endpoint lets you know what rules have been overruled.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_stats_with_http_info(job_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('job_id' not in params or
                params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_stats`")  # noqa: E501
