...
class TMPApi(object):
    ...
    def solve_tmp(self, **kwargs):  # noqa: E501
        """solve a TMP problem  # noqa: E501

        Solves a TMP problem  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.solve_tmp(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TMP body: TMP problem solve request
        :return: Job
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.solve_tmp_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.solve_tmp_with_http_info(**kwargs)  # noqa: E501
            return data

    def solve_tmp_with_http_info(self, **kwargs):  # noqa: E501
        """solve a TMP problem  # noqa: E501

        Solves a TMP problem  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.solve_tmp_with_http_info(async_req=True)
        >>> result = thread.get()
