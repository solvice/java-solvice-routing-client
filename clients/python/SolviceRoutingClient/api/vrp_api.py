...
class VRPApi(object):
    ...
    def get_solution_vrp(self, job_id, **kwargs):  # noqa: E501
        """Solution VRP  # noqa: E501

        Returns the actual solution of the VRP. Only present when the status is `SOLVED`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solution_vrp(job_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_solution_vrp_with_http_info(job_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_solution_vrp_with_http_info(job_id, **kwargs)  # noqa: E501
            return data

    def get_solution_vrp_with_http_info(self, job_id, **kwargs):  # noqa: E501
        """Solution VRP  # noqa: E501

        Returns the actual solution of the VRP. Only present when the status is `SOLVED`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_solution_vrp_with_http_info(job_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_solution_vrp" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params or
                params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_solution_vrp`")  # noqa: E501
